          ...
          <div className="grid grid-cols-2 max-[780px]:grid-cols-1">
            <div className="flex justify-center">
              <div className="text-center font-bold">
                ...
                <h2 className="pt-2"><a href="https://www.certiport.com/portal/pages/credentialverification.aspx?defaultlang=ENU" target="_blank">Verify code: C9vV-XVN9</a></h2>
              </div>
            </div>
            <div className="flex justify-center max-[780px]:pt-4">
              <div className="text-center font-bold">
                ...
                <h2 className="pt-2"><a href="https://www.certiport.com/portal/pages/credentialverification.aspx?defaultlang=ENU" target="_blank">Verify code: 4RcT-XMS8</a></h2>
              </div>
            </div>
          </div>
