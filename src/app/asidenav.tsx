      ...
      <div className=" z-30" id="asd" >
        ...
        <div className="absolute w-[300px] text-center right-[0px] bg-[#ed1c24] text-white text-black top-[85px] ">
          <div className="justify-center flex">
            <div>
              <ul className="space-y-[10px] pt-[30px] text-[20px] uppercase">
                <li><a href="#education" onClick={() => close()} >Edukacja</a></li>
                <li><a href="#cert" onClick={() => close()}>Certyfikaty</a></li>
                <li><a href="#exp" onClick={() => close()}>Doświadczenie</a></li>
                <li><a href="#projects" onClick={() => close()}>Projekty</a></li>
