        ...
        <div className="justify-center flex py-10 " >
            <div className="w-[60%] max-[1600px]:w-[90%] ">
                <div className=" justify-center flex">
                    <h1 className="text-[50px] max-[600px]:text-[40px] max-[370px]:text-[24px]">DOŚWIADCZENIE</h1>
                </div>
                ...
                <div className="py-5 text-[26px] font-bold max-[1050px]:text-[16px] space-y-5">
                    ...
                    <div className="border-[3px] border-[#F00] rounded-[10px] px-5 pb-3 pt-1 bg-[#722]">
                        ...
                        <a>Opis:</a>
                        <div className="text-justify">
                        <a className="font-normal max-[370px]:text-[13px]">Podczas stażu nasz prowadzący zadawał nam proste zadania w Laravel razem z edukacyjnymi materiałami video, które były nam potrzebne do ich rozwiązania. Zostało też przedstawione jak wygląda praca w ich zespole, jak są przydzielane zadania i jak wygląda struktura ich projektów.</a>
                        </div>
